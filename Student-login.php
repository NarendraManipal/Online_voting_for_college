...
if(isset($_POST["submit"]))
{
	...
	if(!empty($_POST['username']) && !empty($_POST['password']))
	{
		...
		$result_student_login = mysqli_query($con,"SELECT USN,LOWER(username),LOWER(password) FROM student_login WHERE username='".$username."' AND password='".$password."'");
...
<body>
  ...
  <div class="login-box">
    ...
    <form class="" action="" method="POST">
      <input type="text" placeholder="username" name="username" value="" maxlength="20" required>
